...
export default function SakerhetMiljoPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pt-24 sm:pt-28">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Säkerhet & Miljö</h1>
          <p className="text-lg text-gray-600 max-w-3xl">
            Kurser inom arbetsmiljö, säkerhet och miljömedvetenhet. 
            Våra kurser hjälper dig att skapa en säker och hållbar arbetsmiljö.
          </p>
        </div>
