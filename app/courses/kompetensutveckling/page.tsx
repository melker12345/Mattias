...
export default function KompetensutvecklingPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Kompetensutveckling</h1>
          <p className="text-lg text-gray-600 max-w-3xl">
            Professionella utbildningar för att utveckla din karriär. 
            Våra kurser ger dig verktyg och kunskaper för att växa i din roll.
          </p>
        </div>
