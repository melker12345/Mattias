          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card hover:shadow-lg transition-shadow duration-300">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Arbete på Väg</h3>
            ...
            <div className="card hover:shadow-lg transition-shadow duration-300">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Säkerhet & Miljö</h3>
                <p className="text-gray-600 mb-4">
            ...
            <div className="card hover:shadow-lg transition-shadow duration-300">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Kompetensutveckling</h3>
                <p className="text-gray-600 mb-4">
